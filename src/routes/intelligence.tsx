...
function IntelligencePage() {
  ...
  return (
    <div>
      <PageHeader
        title="Intelligence"
        description="Ask FarmIQ a question in plain English. Answers are generated by Google Gemini using your farmer dataset."
      />
            ...
            <div className="mt-4 flex items-center justify-between flex-wrap gap-2">
              <p className="text-xs text-muted-foreground">
                {answer?.sources?.length
                  ...
                  : `Powered by Google Gemini · ${farmers.length} farmers loaded from Neo4j.`}
              </p>
